...
const MobileMenuBar = ({ toggleDrawer }) => {
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between p-2 px-3 bg-white/10 mobile-menu-bar sm:px-6 backdrop-blur-md xl:hidden max-w-full overflow-hidden">
      <div className="text-lg font-medium name truncate">
        <Link
        ...
        >
          ...
          />
          <span className="truncate">{siteSettings?.logo?.text}</span>
        </Link>
      </div>
      <button
